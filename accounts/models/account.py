...
class Account(models.Model):
    ...
    username = models.CharField(max_length=255, unique=True, validators=[usernameValidator])
    password = models.CharField(max_length=5000)
    first_name = models.CharField(max_length=30)
    last_name = models.CharField(max_length=30)
    gender = models.CharField(max_length=1, choices=GENDER_CHOICES, validators=[genderValidator])
